...
SECRET_KEY = 'django-insecure-!3$gr^8qryj&_uv8t6t(-ig=mvoozwfg_=go71*u+w_!s16pw*'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = []
LOGIN_URL = '/'  # Перенаправлять на главную страницу
LOGIN_REDIRECT_URL = '/dashboard/'  # После входа
...
print("Base.html path:", BASE_DIR.parent / 'project' / 'static' / 'templates' / 'base.html')
